                ...
                <div class="row g-3">
                    ...
                    <div class="col-12 mt-4 pt-3 border-top">
                        ...
                        <div class="alert alert-info border-0 rounded-3 p-2.5 mb-3 d-flex align-items-start gap-2" style="font-size: 11px;">
                            ...
                            <div>
                                <strong>Verifikasi OTP Keamanan:</strong> Setiap perubahan kata sandi wajib dikonfirmasi dengan <strong>kode OTP 6-digit</strong> yang dikirim ke email akun Anda.
                            </div>
                        </div>

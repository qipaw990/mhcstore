...
<div class="page-header">
    <div class="page-header-left">
        <h4 class="page-title"><i class="bi bi-whatsapp text-success me-2"></i>WhatsApp Gateway &amp; OTP Settings</h4>
    ...
    <div class="page-header-right">
        ...
        <a href="<?= htmlspecialchars($casaosUrl) ?>" target="_blank" class="btn btn-sm btn-outline-primary rounded-pill px-3 fw-bold">

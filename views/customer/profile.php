<div class="border-bottom bg-white d-flex align-items-center justify-content-between sticky-top shadow-xs px-3 py-2.5">
    <h6 class="fw-bold m-0 text-dark" style="font-size: 13.5px; letter-spacing: -0.2px;">Akun Saya</h6>
    <?php if ($user): ?>
...
<div class="px-3 py-3">
    ...
    <?php if ($user): ?>
        ...
        <div class="p-3.5 bg-white border shadow-2xs mb-3 d-flex align-items-center gap-3" style="border-radius: 16px; border-color: #E2E8F0 !important;">
            ...
            <div class="flex-grow-1 min-w-0">
                ...
                <div class="text-muted" style="font-size: 10.5px;"><?= htmlspecialchars($user['phone'] ?? '-') ?></div>
                <?php if (!empty($user['email'])): ?>
                    <div class="text-muted text-truncate" style="font-size: 10px;"><?= htmlspecialchars($user['email']) ?></div>
                <?php endif; ?>
            </div>
            <button type="button" class="btn btn-light btn-sm rounded-circle border shadow-2xs d-flex align-items-center justify-content-center" style="width: 36px; height: 36px; background:#F8FAFC;" data-bs-toggle="modal" data-bs-target="#editProfileModal" title="Edit Profil">
        ...
        <div class="p-3.5 bg-white border shadow-2xs mb-3 d-flex align-items-center justify-content-between" style="border-radius: 16px; border-color: #E2E8F0 !important;">
            <div class="d-flex align-items-center gap-3">
                <div class="rounded-circle d-flex align-items-center justify-content-center text-white" style="width: 40px; height: 40px; font-size: 18px; background: linear-gradient(135deg, #EE2737, #C61524); box-shadow: 0 2px 8px rgba(238,39,55,0.25);">
            ...
            <a href="<?= $baseUrl ?>/wallet" class="btn btn-sm rounded-pill fw-bold px-3.5 py-1.5 text-white shadow-2xs" style="background: linear-gradient(135deg, #EE2737, #C61524); font-size: 10.5px;">
                Isi Saldo
            </a>
        </div>
        ...
        <div class="bg-white border shadow-2xs overflow-hidden mb-3.5" style="border-radius: 16px; border-color: #E2E8F0 !important;">
            <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#editProfileModal" class="p-3.5 d-flex align-items-center justify-content-between text-decoration-none text-dark border-bottom hover-bg-light transition">
                <div class="d-flex align-items-center gap-3">
                    <i class="bi bi-person-gear" style="color: #EE2737 !important; font-size: 17px;"></i>
                    <div>
                        <div class="fw-bold" style="font-size: 12px; letter-spacing: -0.2px;">Edit Profil & Kata Sandi</div>
            ...
            <a href="<?= $baseUrl ?>/orders" class="p-3.5 d-flex align-items-center justify-content-between text-decoration-none text-dark border-bottom hover-bg-light transition">
                <div class="d-flex align-items-center gap-3">
                    <i class="bi bi-receipt" style="color: #EE2737 !important; font-size: 17px;"></i>
                    <span class="fw-bold" style="font-size: 12px; letter-spacing: -0.2px;">Riwayat Pesanan</span>
                </div>
                <i class="bi bi-chevron-right text-muted" style="font-size: 11px;"></i>
            </a>

            <a href="<?= $baseUrl ?>/search" class="p-3.5 d-flex align-items-center justify-content-between text-decoration-none text-dark border-bottom hover-bg-light transition">
                <div class="d-flex align-items-center gap-3">
                    <i class="bi bi-percent text-warning" style="font-size: 17px;"></i>
                    <span class="fw-bold" style="font-size: 12px; letter-spacing: -0.2px;">Voucher & Promo Saya</span>
                </div>
                <i class="bi bi-chevron-right text-muted" style="font-size: 11px;"></i>
            </a>

            <a href="<?= $baseUrl ?>/notifications" class="p-3.5 d-flex align-items-center justify-content-between text-decoration-none text-dark border-bottom hover-bg-light transition">
                <div class="d-flex align-items-center gap-3">
                    <i class="bi bi-bell text-primary" style="font-size: 17px;"></i>
                    <span class="fw-bold" style="font-size: 12px; letter-spacing: -0.2px;">Pusat Notifikasi</span>
                </div>
                <i class="bi bi-chevron-right text-muted" style="font-size: 11px;"></i>
            </a>

            <a href="javascript:void(0)" onclick="Swal.fire('Pusat Bantuan', 'Hubungi layanan pelanggan CicalengkaGO via WhatsApp di 0812-3456-7890', 'info')" class="p-3.5 d-flex align-items-center justify-content-between text-decoration-none text-dark border-bottom hover-bg-light transition">
                <div class="d-flex align-items-center gap-3">
                    <i class="bi bi-question-circle-fill text-info" style="font-size: 17px;"></i>
                    <span class="fw-bold" style="font-size: 12px; letter-spacing: -0.2px;">Bantuan & CS 24 Jam</span>
                </div>
                <i class="bi bi-chevron-right text-muted" style="font-size: 11px;"></i>
            </a>

            <a href="<?= $baseUrl ?>/logout" class="p-3.5 d-flex align-items-center justify-content-between text-decoration-none text-danger hover-bg-light transition">
                <div class="d-flex align-items-center gap-3">
                    <i class="bi bi-box-arrow-right" style="font-size: 17px;"></i>
                    <span class="fw-bold" style="font-size: 12px; letter-spacing: -0.2px;">Keluar Akun</span>
                </div>

        ...
        try {
            ...
            $this->successResponse('Status panggilan', [
                'active_call' => [
                    ...
                    'status'              => $call['status'],
                    'offer'               => !empty($call['offer']) ? (is_string($call['offer']) ? (json_decode($call['offer'], true) ?: $call['offer']) : $call['offer']) : null,
                    'answer'              => !empty($call['answer']) ? (is_string($call['answer']) ? (json_decode($call['answer'], true) ?: $call['answer']) : $call['answer']) : null,
                    'ice_candidates'      => !empty($call['ice_candidates']) ? (is_string($call['ice_candidates']) ? (json_decode($call['ice_candidates'], true) ?: $call['ice_candidates']) : $call['ice_candidates']) : [],

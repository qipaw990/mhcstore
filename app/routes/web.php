...
Router::get('/products', [\App\Controllers\ApiController::class, 'products']);
Router::get('/api/products/{id}', [\App\Controllers\ApiController::class, 'productDetail']);
Router::get('/products/{id}', [\App\Controllers\ApiController::class, 'productDetail']);
...
Router::get('/api/stores', [\App\Controllers\ApiController::class, 'stores']);
Router::get('/api/stores/{id}', [CustomerController::class, 'storeDetail']);
Router::get('/api/wallet', [\App\Controllers\ApiController::class, 'wallet']);
Router::get('/api/vendor/wallet', [\App\Controllers\VendorController::class, 'wallet']);
Router::get('/api/vendor/products', [\App\Controllers\VendorController::class, 'products']);
Router::post('/api/vendor/products/save', [\App\Controllers\VendorController::class, 'saveProduct']);
Router::post('/api/vendor/products/create', [\App\Controllers\VendorController::class, 'saveProduct']);
Router::get('/api/vendor/raw-materials', [\App\Controllers\VendorController::class, 'rawMaterials']);
Router::post('/api/vendor/raw-materials/save', [\App\Controllers\VendorController::class, 'saveRawMaterial']);
Router::post('/api/vendor/raw-materials/delete', [\App\Controllers\VendorController::class, 'deleteRawMaterial']);
...
Router::post('/api/products/recipe/save', [\App\Controllers\VendorController::class, 'saveProductRecipe']);
Router::post('/api/vendor/products/recipe/save', [\App\Controllers\VendorController::class, 'saveProductRecipe']);
Router::get('/api/vendor/products/{id}/recipe', [\App\Controllers\VendorController::class, 'getProductRecipe']);
Router::get('/api/cart', [\App\Controllers\ApiController::class, 'cart']);
Router::post('/api/cart', [\App\Controllers\ApiController::class, 'cart']);
Router::post('/api/cart/add', [CartController::class, 'add']);
Router::post('/api/cart/update-qty', [CartController::class, 'updateQty']);
...
Router::get('/api/app-config',  [\App\Controllers\ApiController::class, 'appConfig']);

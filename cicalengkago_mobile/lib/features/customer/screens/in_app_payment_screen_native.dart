          ...
          children: [
            ...
            Row(
              children: [
                ...
                Text(
                  'Pembayaran Aman • ${CurrencyFormatter.formatRupiah(widget.amount)}',
                  ...
                  const Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Klik di samping untuk simulasi bayar instant.',
  ...
  void _showCancelDialog(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text('Pembayaran belum diselesaikan. Yakin ingin keluar?'),
        actions: [
          TextButton(
